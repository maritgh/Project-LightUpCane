              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        accentButton(S.of(context).red, Colors.red[400]!,
                            themeProvider, screenWidth),
                        accentButton(S.of(context).orange, Colors.orange[400]!,
                            themeProvider, screenWidth),
                        accentButton(S.of(context).yellow, Colors.yellow[600]!,
                            themeProvider, screenWidth),
                        accentButton(S.of(context).green, Colors.green[400]!,
                            themeProvider, screenWidth),
                      ],
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        accentButton(S.of(context).blue, Colors.blue[400]!,
                            themeProvider, screenWidth),
                        accentButton(S.of(context).purple, Colors.purple[400]!,
                            themeProvider, screenWidth),
                        accentButton(S.of(context).white, Colors.white,
                            themeProvider, screenWidth),
                        accentButton(S.of(context).black, Colors.black,
                            themeProvider, screenWidth),
                      ],
                    ),
                  ),
